...
CREATE TABLE `rating` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_OrderRating` (`order_id`),
  KEY `FK_Driver_ID_Rating` (`driver_id`),
  KEY `FK_Restaurant_ID_Rating` (`restaurant_id`),
  CONSTRAINT `FK_Driver_ID_Rating` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `FK_OrderRating` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
  CONSTRAINT `FK_Restaurant_ID_Rating` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
...
INSERT INTO `rating` VALUES (1,1,'2021-12-01',1,7,1),(2,2,'2020-09-10',2,9,2),(3,3,'2020-10-14',3,4,3),(4,4,'2021-07-14',4,10,4),(5,5,'2021-07-15',5,3,5),(6,6,'2021-02-18',6,1,6),(7,7,'2020-11-01',7,3,7),(8,8,'2020-12-11',8,8,8),(9,9,'2021-04-20',9,7,1),(10,10,'2021-07-04',10,1,2),(11,11,'2020-12-20',11,5,3),(12,12,'2021-06-14',12,2,4),(13,13,'2021-11-20',13,5,5),(14,14,'2020-06-19',14,1,6),(15,15,'2021-01-22',15,2,7),(16,16,'2021-10-30',16,3,8),(17,17,'2020-02-10',17,3,1),(18,18,'2021-06-13',18,2,2),(19,19,'2021-08-16',19,3,3),(20,20,'2021-07-30',20,2,4),(21,21,'2020-02-01',21,2,5),(22,22,'2020-03-08',22,6,6),(23,23,'2020-01-26',23,10,7),(24,24,'2020-06-25',24,9,8),(25,25,'2020-02-25',25,4,1),(26,26,'2021-05-09',26,2,2),(27,27,'2020-01-15',27,3,3),(28,28,'2020-02-04',28,8,4),(29,29,'2020-09-07',29,2,5),(30,30,'2021-08-22',30,6,6),(31,31,'2021-02-07',31,4,7),(32,32,'2021-02-14',32,3,8),(33,33,'2020-01-20',33,3,1),(34,34,'2021-09-19',34,2,2),(35,35,'2020-12-07',35,2,3),(36,36,'2020-04-12',36,2,4),(37,37,'2019-12-10',37,3,5),(38,38,'2020-11-13',38,7,6),(39,39,'2020-09-25',39,6,7),(40,40,'2021-05-09',40,8,8),(41,41,'2019-12-14',41,5,1),(42,42,'2020-01-31',42,1,2),(43,43,'2021-10-22',43,2,3),(44,44,'2021-06-15',44,5,4),(45,45,'2021-07-24',45,7,5),(46,46,'2021-07-11',46,3,6),(47,47,'2021-02-13',47,6,7),(48,48,'2021-03-22',48,7,8),(49,49,'2021-10-26',49,1,1),(50,50,'2020-10-25',50,10,2),(51,51,'2021-10-06',51,8,3),(52,52,'2020-08-04',52,6,4),(53,53,'2020-07-08',53,1,5),(54,54,'2021-05-27',54,1,6),(55,55,'2021-11-18',55,8,7),(56,56,'2020-10-13',56,10,8),(57,57,'2020-09-05',57,4,1),(58,58,'2020-05-27',58,3,2),(59,59,'2021-02-13',59,9,3),(60,60,'2021-05-21',60,3,4),(61,61,'2020-07-30',61,10,5),(62,62,'2020-05-22',62,4,6),(63,63,'2020-01-15',63,6,7),(64,64,'2020-12-08',64,7,8),(65,65,'2020-03-24',65,9,1),(66,66,'2021-12-04',66,3,2),(67,67,'2019-12-23',67,8,3),(68,68,'2021-07-08',68,3,4),(69,69,'2020-05-26',69,3,5),(70,70,'2021-06-13',70,6,6),(71,71,'2021-08-08',71,9,7),(72,72,'2020-06-13',72,8,8),(73,73,'2020-08-07',73,10,1),(74,74,'2021-02-25',74,2,2),(75,75,'2020-09-09',75,9,3),(76,76,'2021-08-21',76,2,4),(77,77,'2020-03-05',77,10,5),(78,78,'2020-08-29',78,2,6),(79,79,'2021-07-22',79,2,7),(80,80,'2021-05-06',80,10,8),(81,81,'2021-08-03',81,7,1),(82,82,'2021-09-25',82,2,2),(83,83,'2020-07-12',83,3,3),(84,84,'2021-06-17',84,1,4),(85,85,'2020-06-08',85,4,5),(86,86,'2020-09-22',86,2,6),(87,87,'2020-01-18',87,9,7),(88,88,'2020-01-13',88,4,8),(89,89,'2020-11-24',89,1,1),(90,90,'2020-12-01',90,6,2),(91,91,'2021-09-29',91,3,3),(92,92,'2020-08-24',92,7,4),(93,93,'2021-07-08',93,2,5),(94,94,'2020-07-01',94,10,6),(95,95,'2020-08-20',95,2,7),(96,96,'2020-11-28',96,4,8),(97,97,'2020-08-25',97,6,1),(98,98,'2020-07-24',98,6,2),(99,99,'2021-03-14',99,10,3),(100,100,'2021-04-15',100,7,4),(101,101,NULL,5,NULL,4),(128,NULL,NULL,NULL,NULL,NULL),(129,NULL,NULL,NULL,NULL,NULL),(130,NULL,NULL,NULL,NULL,NULL),(131,NULL,NULL,NULL,NULL,NULL),(132,NULL,NULL,NULL,NULL,NULL),(133,NULL,NULL,NULL,NULL,NULL),(134,NULL,NULL,NULL,NULL,NULL),(135,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2020-12-08 19:36:40
